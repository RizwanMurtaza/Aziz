...
namespace Nop.Plugin.Widgets.GamingHeroSlider.Infrastructure.Cache;
    ...
    IConsumer<EntityDeletedEvent<Setting>>
{
    ...
    /// </summary>
    protected static string PictureUrlPrefix => "Nop.plugins.widgets.gaminghero";
    ...
    /// {1} : secured
    /// </remarks>
    public static CacheKey PictureUrlModelKey => new("Nop.plugins.widgets.gaminghero.pictureurl-{0}-{1}", PictureUrlPrefix);
